...
describe(`button`, () => {
  it('button children show correctly', () => {
    ...
    const button = component.find('.lordaeron-button');
  ...
  it('button type set show correctly color', () => {
    ...
    expect(component.find('.lordaeron-button .btn-primary').length).toBe(1);
  });

  // it('button loading show correctly', () => {
  //   // 测试加载按钮显示
  //   const component = mount(<Button type="primary" loading />);
  //   expect(component.find('lordaeron-button-loading')).not.toBeUndefined();
  // });
});
